...
type Packet struct {
	...
	Source      Network    `protobuf:"varint,8,opt,name=source,proto3,enum=Network" json:"source,omitempty"`
	Destination Network    `protobuf:"varint,9,opt,name=destination,proto3,enum=Network" json:"destination,omitempty"`
...
func (x *Packet) GetSource() Network {
	if x != nil {
		return x.Source
	}
...
func (x *Packet) GetDestination() Network {
	if x != nil {
...
var file_konnectivity_client_proto_client_client_proto_rawDesc = []byte{
	...
	,
...
var file_konnectivity_client_proto_client_client_proto_depIdxs = []int32{
	...
	2,  // 1: Packet.source:type_name -> Network
	2,  // 2: Packet.destination:type_name -> Network
	4,  // 3: Packet.dialRequest:type_name -> DialRequest
	5,  // 4: Packet.dialResponse:type_name -> DialResponse
	9,  // 5: Packet.data:type_name -> Data
	6,  // 6: Packet.closeRequest:type_name -> CloseRequest
	7,  // 7: Packet.closeResponse:type_name -> CloseResponse
	8,  // 8: Packet.closeDial:type_name -> CloseDial
	3,  // 9: ProxyService.Proxy:input_type -> Packet
	3,  // 10: ProxyService.Proxy:output_type -> Packet
