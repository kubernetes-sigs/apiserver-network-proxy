...
func TestRemovePendingDialForStream(t *testing.T) {
	...
	p := NewProxyServer("", []ProxyStrategy{ProxyStrategyDefault}, servercounter.StaticServerCounter(1), nil, xfrChannelSize)
...
func TestAddRemoveBackends_DefaultRouteStrategy(t *testing.T) {
	...
	p := NewProxyServer("", []ProxyStrategy{ProxyStrategyDefaultRoute}, servercounter.StaticServerCounter(1), nil, xfrChannelSize)
...
func TestAddRemoveBackends_DestHostStrategy(t *testing.T) {
	...
	p := NewProxyServer("", []ProxyStrategy{ProxyStrategyDestHost}, servercounter.StaticServerCounter(1), nil, xfrChannelSize)
...
func TestAddRemoveBackends_DestHostWithDefault(t *testing.T) {
	...
	p := NewProxyServer("", []ProxyStrategy{ProxyStrategyDestHost, ProxyStrategyDefault}, servercounter.StaticServerCounter(1), nil, xfrChannelSize)
...
func baseServerProxyTestWithoutBackend(t *testing.T, validate func(*agentmock.MockAgentService_ConnectServer)) {
	...
	proxyServer := NewProxyServer(uuid.New().String(), []ProxyStrategy{ProxyStrategyDefault}, servercounter.StaticServerCounter(1), &AgentTokenAuthenticationOptions{}, xfrChannelSize)
...
func TestReadyBackendsMetric(t *testing.T) {
	...
	p := NewProxyServer(uuid.New().String(), []ProxyStrategy{ProxyStrategyDefault}, servercounter.StaticServerCounter(1), &AgentTokenAuthenticationOptions{}, xfrChannelSize)
