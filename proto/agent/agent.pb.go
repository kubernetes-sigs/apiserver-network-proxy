...
type Packet struct {
	Type PacketType `protobuf:"varint,1,opt,name=type,enum=PacketType" json:"type,omitempty"`
...
type Packet_DialRequest struct {
	DialRequest *DialRequest `protobuf:"bytes,2,opt,name=dialRequest,oneof"`
}
type Packet_DialResponse struct {
	DialResponse *DialResponse `protobuf:"bytes,3,opt,name=dialResponse,oneof"`
}
type Packet_Data struct {
	Data *Data `protobuf:"bytes,4,opt,name=data,oneof"`
}
...
type DialRequest struct {
	...
	Random int64 `protobuf:"varint,3,opt,name=random" json:"random,omitempty"`
}
...
func (*DialRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
type DialResponse struct {
	...
	ConnectID int64 `protobuf:"varint,2,opt,name=connectID" json:"connectID,omitempty"`
...
func (*DialResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
type Data struct {
	...
	ConnectID int64 `protobuf:"varint,1,opt,name=connectID" json:"connectID,omitempty"`
...
func (c *proxyServiceClient) Proxy(ctx context.Context, opts ...grpc.CallOption) (ProxyService_ProxyClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ProxyService_serviceDesc.Streams[0], c.cc, "/ProxyService/Proxy", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentServiceClient) Connect(ctx context.Context, opts ...grpc.CallOption) (AgentService_ConnectClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_AgentService_serviceDesc.Streams[0], c.cc, "/AgentService/Connect", opts...)
	if err != nil {
		return nil, err
	}
